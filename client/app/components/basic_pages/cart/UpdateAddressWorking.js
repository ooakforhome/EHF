...
class UpdateAddress extends Component {
  constructor(props){
    super(props);
      this.state={
        address: (localStorage.shipping_address)?JSON.parse(localStorage.shipping_address):{}
      }
  }
    ...
    return(
      <>
        <div className="update_address_container">
          ...
          <button onClick={this.formSubmit.bind(this)} className="change_address_btn">SUBMIT</button>
      </>
    )
  }
