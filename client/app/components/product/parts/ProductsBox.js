    ...
    <div className="innerBody">
      <div className="item_img">
        <div className="item_img_box">
          <img src={(`${process.env.Node}/api/image/undefined`)? `http://localhost:3080/api/image/${images}` : "https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg"} alt={Product_Name}/>
        </div>
        </div>
